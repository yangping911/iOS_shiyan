...
class ViewController: UIViewController , UITableViewDelegate,UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        //Teacher类
        //Teacher类
        let teacher1 = Teacher(firstName: "Flames", lastName: "Bronx", age: 27, gender: Gender.male, title: "Maths", department: Department.departA)
        let teacher2 = Teacher(firstName: "Tidal", lastName: "Glory", age: 49, gender: Gender.male, title: " Piano", department: Department.departA)
        teachers.append(teacher1)
        teachers.append(teacher2)
        //Student类
        let studentA = Student(firstName: "Isaac", lastName: "Ray", age: 18, gender: Gender.female, stuNo: "2018120201",department: Department.departD)
        let studentB = Student(firstName: "Mcavoy", lastName: "Finn", age: 19, gender: Gender.male, stuNo: "2018120207",department: Department.departB)
        let studentC = Student(firstName: "Remady", lastName: "Wolfhard", age: 15 , gender: Gender.male,stuNo: "2018120213",department: Department.departB)
        let  studentD = Student(firstName: "Broun", lastName: "Martini", age: 20, gender: .male,stuNo: "2018120240",department: Department.departB)
        let  studentE = Student(firstName: "Zeeba", lastName: "Kopf", age: 20, gender: .male,stuNo: "2018120243",department: Department.departB)
